...
import numpy as np
import math
from licenseRecog import recognizer
import random

from licenseRecog import Preprocess
from licenseRecog import DetectChars
from licenseRecog import PossiblePlate
from licenseRecog import PossibleChar
...
def detectPlatesInScene(imgOriginalScene):
    ...
    if recognizer.showSteps == True: # show steps #######################################################
    ...
    if recognizer.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, recognizer.SCALAR_WHITE)
    ...
    if recognizer.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), recognizer.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), recognizer.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), recognizer.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), recognizer.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if recognizer.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, recognizer.SCALAR_WHITE)
        # end if # show steps #####################################################################
